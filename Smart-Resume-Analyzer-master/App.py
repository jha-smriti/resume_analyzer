...
st.set_page_config(
    ...
    page_icon='./Logo/new_logo.png',  # Update this line
    layout="wide"
)
...
def run():
    ...
    img = Image.open('./Logo/new_logo.png')
                ...
                if resume_data:
                    ...
                    for i in resume_data['skills']:
                        if i.lower() in ds_keyword:
                            ...
                            st.markdown('''<h4 style='text-align: left; color: #1ed760;'>Adding this skills to your resume will boost🚀 the chances of getting a Job💼</h4>''', unsafe_allow_html=True)
                    ...
                    if 'Objective' in resume_text:
                        ...
                        st.markdown('''<h4 style='text-align: left; color: #fabc10;'>[-] Adding a career objective to your resume is highly recommended, as it clearly communicates your career goals and intentions to recruiters.</h4>''', unsafe_allow_html=True)

                    if 'Declaration' in resume_text:
                        resume_score = resume_score + 20
                        st.markdown('''<h4 style='text-align: left; color: #1ed760;'>[+] Awesome! You have added Declaration ✍</h4>''', unsafe_allow_html=True)
                    else:
                        st.markdown('''<h4 style='text-align: left; color: #fabc10;'>[-] Including a declaration on your resume is recommended, as it assures recruiters that all the information provided is accurate and has been verified by you.</h4>''', unsafe_allow_html=True)
                    ...
                    if 'Hobbies' in resume_text or 'Interests' in resume_text:
                        ...
                        st.markdown('''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add Hobbies⚽. It will show your personality to the recruiters and give the assurance that you are fit for this role.</h4>''', unsafe_allow_html=True)
                    ...
                    if 'Projects' in resume_text:
                        ...
                        st.markdown('''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add Projects👨‍💻. It will show that you have done work related the required position.</h4>''', unsafe_allow_html=True)
