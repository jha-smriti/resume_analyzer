...
# YouTube video links for Data Science
ds_videos = [
    'https://youtu.be/y8YH0Qbu5h4',  # Example video
    'https://youtu.be/Ji46s5BHdr0',  # Example video
    'https://youtu.be/yp693O87GmM',  # Example video
    'https://youtu.be/UeMmCex9uTU',  # Example video
    'https://youtu.be/dQ7Q8ZdnuN0'   # Example video
]

# YouTube video links for Web Development
web_videos = [
    'https://youtu.be/e1IyzVyrLSU',  # Example video
    'https://youtu.be/Dorf8i6lCuk',  # Example video
    'https://youtu.be/Oe421EPjeBE',  # Example video
    'https://youtu.be/py3n6gF5Y00',  # Example video
    'https://youtu.be/3nLTB_E6XAM'   # Example video
]

# YouTube video links for Android Development
android_videos = [
    'https://youtu.be/fis26HvvDII',  # Example video
    'https://youtu.be/6WQpTwXh-6k',  # Example video
    'https://youtu.be/VaMWsm6CFss',  # Example video
    'https://youtu.be/4L7G7lI2lYk',  # Example video
    'https://youtu.be/4L7G7lI2lYk'   # Example video
]

# YouTube video links for iOS Development
ios_videos = [
    'https://youtu.be/comQ1-x2a1Q',  # Example video
    'https://youtu.be/FcsY1YPBwzQ',  # Example video
    'https://youtu.be/6WQpTwXh-6k',  # Example video
    'https://youtu.be/VaMWsm6CFss',  # Example video
    'https://youtu.be/4L7G7lI2lYk'   # Example video
]

# YouTube video links for UI/UX Development
uiux_videos = [
    'https://youtu.be/68w2VwalD5w',  # Example video
    'https://youtu.be/WEljsc2jorI',  # Example video
    'https://youtu.be/yp693O87GmM',  # Example video
    'https://youtu.be/UeMmCex9uTU',  # Example video
    'https://youtu.be/dQ7Q8ZdnuN0'   # Example video
]